...
client.on('ready', () => {
  console.log(`[Solar]: ${client.user.username} adı ile giriş yaptı!`);
});

client.on('message', msg => {
  console.log(`[Solar] LOG: S: ${msg.guild.name} M: ${msg.content} Y: ${msg.author.tag}`);
  ...
  if (msg.content.toLowerCase() === prefix + 'reboot') {
    if (msg.author.id !== ayarlar.sahip) {
      ...
      console.log(`[Solar]: Bot yeniden başlatılıyor...`);
      process.exit(0);
    })
   }
  }
